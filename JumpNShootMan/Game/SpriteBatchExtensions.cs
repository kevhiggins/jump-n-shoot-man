...
namespace JumpNShootMan.Sprites
{
    public static class SpriteBatchExtensions
    {
        ...
        public static void Draw(this SpriteBatch spriteBatch, Sprite sprite)
        {
            ...
            if (sprite.IsVisible)
            {
                ...
                spriteBatch.Draw(texture, sprite.Position + sprite.Origin, sourceRectangle, sprite.Color * sprite.Alpha, sprite.Rotation, sprite.Origin,
